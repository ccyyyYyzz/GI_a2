...
| E3 | bench-transfer validity boundary (End Matter C): calibrated leak law "L(z1)=6.94e-3+5.92e-3·(z1/mm)^0.90", CVs "2.2%/2.2%/0.1%", floor = fill + macro-staircase; thin-screen spacing "≤0.3 mm" (developed) / "1–2 mm" (weak) | WAVE_TWIN + R44_KILL_TESTS | `IT3_leak_law_stability.json` (law + CVs); `IT2_floor_decomposition.json` (fill 6% / staircase 50%); `T4_MULT_TO_CONV.json` (α=0.5 at z2=0.327 mm); wording frozen by R45 §C7 (issue #36), superseding the R44 §3 generic sentence | bb95d77 |
