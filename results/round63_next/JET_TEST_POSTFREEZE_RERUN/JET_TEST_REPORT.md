...
Runtime 963 s. All scored checks:
...
|---|---|---|---|---|
| delta_g | **2.015** (2) | 2.015 | 2.015 | 1.0027 |
| delta_o | **4.000** (4) | 4.000 | 3.993 | 1.0000 |
| delta_n | **4.000** (4) | 4.000 | 3.946 | 0.9994 |

- **delta_g** (generic, c≠0): exact-KL contact order 2, coefficient `c²‖K‖²` matched to 0.27%.
...
|---|---|---|---|
| delta_g | **1.17** | 1 | 0.050:3.11, 0.035:1.86, 0.025:1.50, 0.018:0.89 |
| delta_o | **1.99** | 2 | 0.160:4.10, 0.120:2.66, 0.090:1.41, 0.060:0.60 |
...
|---|---|---|---|
| delta_g | **-2.19** | -2 | 0.060:1794, 0.040:4075, 0.028:9673, 0.020:19332 |
| delta_o | **-3.98** | -4 | 0.160:1514, 0.120:4562, 0.090:14635, 0.065:54111 |
...
**Signed cancellation:** ε_* = −2c/d = 0.3626. At ε_* the covariance is identical (z=0.00e+00), so AUC = **0.516** (chance) — despite clear local visibility either side (AUC 0.000 at 0.25ε_*, 1.000 at 1.8ε_*; |AUC−0.5| = 0.500 / 0.500). Detection is a *local* quotient statement; iso-Q surfaces are globally invisible.
...
- ε⁻⁴ class expensive-not-vanishing: MC delta_o m=1.99 (>0).
